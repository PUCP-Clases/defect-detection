...
def plt_fig(test_img, scores, img_scores, gts, threshold, cls_threshold, save_dir, class_name):
    ...
    for i in range(num):
        ...
        fig_img, ax_img = plt.subplots(1, 3, figsize=(9, 3), gridspec_kw={'width_ratios': [4, 4, 3]})
        ...
        ax_img[1].imshow(vis_img, cmap='gray', alpha=0.7, interpolation='none')
        ax_img[1].imshow(img, cmap='gray', alpha=0.1, interpolation='none')
        ax_img[1].title.set_text('Segmentation')
